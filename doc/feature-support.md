...
| Manual PINGREQ | ✓ | `Client::ping` submits a PINGREQ on demand, irrespective of Keep Alive, and returns a completion token that resolves with the round-trip time when the corresponding PINGRESP is received. |
