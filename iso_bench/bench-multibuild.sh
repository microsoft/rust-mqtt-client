...
# either way, scoring 32-33 gated cells under multibuild against 26-32 single-build. Multibuild
# suppresses the artefact without costing detection. See SENSITIVITY.md.
#
