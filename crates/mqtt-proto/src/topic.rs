...
use crate::{ByteStr, DecodeError, EncodeError, MULTI_LEVEL_MATCH, SEPARATOR, SINGLE_LEVEL_MATCH};
...
pub fn topic(s: impl AsRef<str>) -> Topic<crate::ByteStr<buffer_pool::tests::SharedImpl>> {
    let t = crate::byte_str(s);
