...
macro_rules! encode_decode_v3 {
    ...
    (
        ...
        $($attrs)*
        fn encode_decode_v3(packet: Packet<buffer_pool::tests::SharedImpl>, expected_encoding: Option<&[u8]>) {
            let mut encoding = crate::tests::encode(&packet, crate::ProtocolVersion::V3);
            ...
            let decoded_packet = crate::tests::decode(&mut encoding, crate::ProtocolVersion::V3);
...
macro_rules! encode_decode_v5 {
    ...
    (
        ...
        $($attrs)*
        fn encode_decode_v5(packet: Packet<buffer_pool::tests::SharedImpl>, expected_encoding: Option<&[u8]>) {
...
mod tests {
    ...
    #[test]
    fn packets_sizes() {
        use buffer_pool::bytes::SharedImpl;
